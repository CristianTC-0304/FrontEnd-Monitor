...
export class CreatesalaryComponent implements OnInit {
  ...
  saveSalary() {
    this.salary.salario = this.salary.salario.toString();   
    this.salary.auxilioTransporte = this.salary.auxilioTransporte.toString();
    this.salary.prestacionesSociales = this.salary.prestacionesSociales.toString();    
    this.salary.periodo = this.salary.periodo;
